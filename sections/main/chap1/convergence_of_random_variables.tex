    ...
    \begin{enumerate}
        ...
        \begin{align*}
            \int f d\Pm_n &= \int \int_0^b \1{t < f}dt d\Pm_n \\
                ...
                &= \int_0^b \Pm_n(f^{-1}(0, t))dt.
        \end{align*} 

        \noindent By Dominated Convergence Theorem, we have $\int_0^b \Pm_n(f^{-1}(0, t))dt \to \int_0^b \Pm(f^{-1}(0, t))dt$. Hence, we obtain the desired result.
    \end{enumerate} 
\end{proof*} 
