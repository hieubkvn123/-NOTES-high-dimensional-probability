...
%% Examples %%
\theoremstyle{definition}
\declaretheorem[name=Example, numberwithin=section]{exm}
\newenvironment{example}{\begin{shaded}\begin{exm}}{\end{exm}\end{shaded}}
\colorlet{shadecolor}{white!25}

%% Definitions %%
\theoremstyle{definition}
\declaretheorem[name=Definition, numberwithin=section]{dfn}
\addto\captionsenglish{ \renewcommand{\listtheoremname}{II\hspace{0.5em}. List of Definitions} }
...
\newcommand{\bU}{{\bf U}}
\newcommand{\bu}{{\bf u}}
\newcommand{\btheta}{\boldsymbol{\theta_*}}
